...
<input type="text" placeholder="Username" class="input" name="username" value="" ><br><br>
<input type="text" placeholder="Password" class="input" name="password" value="" ><br><br>
<input type="submit" name="button" value="login" style="font-size:30px; background-color:green; width:110px; " class="sub"><br>
</form>
</center>
<br><br>
...

{
    $user= $_POST['username'];
    $pwd= $_POST['password'];
    $sql="SELECT * FROM admin WHERE user='$user' && pass='$pwd'";
